...
- [ ] 1.1 `release-please.yml` configured for a Python app (`pyproject.toml` +
      `VERSION` + `src/fyi_archive/version.py` as version files).
- [ ] 1.2 `CHANGELOG.md` bootstrapped; release-please owns it thereafter.
- [ ] 1.3 CONTRIBUTING note on Conventional Commits.

## Phase 2: Version-consistency gate

- [ ] 2.1 `check_version_consistency.py` as a required `tests.yml` gate.
