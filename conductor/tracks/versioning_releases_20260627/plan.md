...
- [x] 1.3 CONTRIBUTING note on Conventional Commits.

## Phase 2: Version-consistency gate
- [x] 2.1 `check_version_consistency.py` as a required `tests.yml` gate.
- [x] 2.2 release-please bump propagates to all three sources.

## Phase 3: Release artifacts + Zenodo link
- [x] 3.1 Release job attaches `dist/` bundle + SBOM + provenance.
- [x] 3.2 `CITATION.cff` DOI update step wired into `zenodo_publish.yml`.
- [x] 3.3 Independent versioning axes documented.
