...
routine discovery. `alaveteli_historical_all_captures.yml` runs monthly and
supports bounded, resumable dispatches without a conversational confirmation.
It is an index export, not replayed page content: an immutable manifest
